...
const ALGO_SYMBOLS = [
  { char: '∑', x: 5, y: 20, size: 30, drift: 22, delay: 0 },
  { char: 'O(n)', x: 15, y: 55, size: 32, drift: 28, delay: 2.5 },
  { char: 'λ', x: 88, y: 35, size: 32, drift: 25, delay: 1.2 },
  { char: 'Δ', x: 75, y: 70, size: 30, drift: 30, delay: 3.8 },
  { char: '∫', x: 92, y: 15, size: 32, drift: 26, delay: 4.1 },
  { char: '∞', x: 50, y: 85, size: 30, drift: 24, delay: 2.0 },
  { char: 'π', x: 10, y: 80, size: 32, drift: 29, delay: 5.3 },
  { char: 'O(log n)', x: 82, y: 60, size: 17, drift: 32, delay: 1.8 },
  { char: '→', x: 35, y: 30, size: 32, drift: 27, delay: 3.2 },
  { char: 'Θ', x: 62, y: 45, size: 30, drift: 31, delay: 0.7 },
  { char: '{ }', x: 42, y: 75, size: 17, drift: 26, delay: 4.5 },
  { char: '∀', x: 28, y: 50, size: 32, drift: 28, delay: 2.8 },
  { char: '∂', x: 68, y: 25, size: 32, drift: 24, delay: 1.5 },
  { char: 'Ω', x: 18, y: 65, size: 30, drift: 30, delay: 3.6 },
  { char: '⊥', x: 55, y: 15, size: 32, drift: 27, delay: 0.3 },
  { char: '√', x: 45, y: 90, size: 30, drift: 33, delay: 5.0 },
  { char: 'φ', x: 95, y: 50, size: 30, drift: 25, delay: 2.2 },
  { char: '≈', x: 22, y: 40, size: 17, drift: 29, delay: 4.8 },
  { char: '[ ]', x: 72, y: 80, size: 30, drift: 28, delay: 1.1 },
  { char: '∇', x: 32, y: 70, size: 32, drift: 31, delay: 3.4 },
  { char: '∈', x: 85, y: 90, size: 17, drift: 26, delay: 0.9 },
  { char: 'O(1)', x: 48, y: 60, size: 17, drift: 30, delay: 4.3 },
  { char: 'α', x: 8, y: 45, size: 17, drift: 27, delay: 2.7 },
  { char: '≠', x: 65, y: 55, size: 17, drift: 32, delay: 1.6 },
  { char: '⇒', x: 40, y: 20, size: 30, drift: 26, delay: 3.9 },
  { char: 'n!', x: 58, y: 35, size: 32, drift: 29, delay: 0.5 },
  { char: '0 1', x: 78, y: 45, size: 17, drift: 28, delay: 5.5 },
  { char: '</>', x: 25, y: 85, size: 30, drift: 31, delay: 2.4 },
  { char: '⌈⌉', x: 52, y: 72, size: 32, drift: 27, delay: 3.7 },
  { char: 'O(n²)', x: 12, y: 30, size: 17, drift: 33, delay: 1.9 },
];
