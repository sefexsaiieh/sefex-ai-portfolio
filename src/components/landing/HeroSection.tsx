...
export function HeroSection({ onCtaClick }: HeroSectionProps) {
  ...
  return (
    <section className="flex flex-col items-center text-center px-4 py-16 md:py-24">
      <div className="inline-flex items-center gap-2 px-3 py-1 mb-6 text-xs font-medium text-accent-700 bg-accent-50 rounded-full border border-accent-100">
      ...
      <p className="mt-3 text-xl md:text-2xl font-medium text-accent-600">
        {t('hero.subtitle')}
      </p>
